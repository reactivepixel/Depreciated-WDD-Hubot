...
module.exports = (robot) ->
  ...
  robot.respond /ambush (.*?): (.*)/i, (msg) ->
    ...
    facepalmArray = [
        ...
        "........................................_..........._,-%.......` "
        "..................................., "]
    # picard facepalm ASCII

    facepalmTest = /// #begin of line
    (^--facepalm$)
    ///i            #end of line and ignore case
    # if the target user of a --facepalm is bkerickson, the sender receives an ASCII facepalm
    ...
    if users.length is 1 and users[0].name is 'bkerickson'
      ...
      if msg.match[2].match facepalmTest
        ...
        for num in facepalmArray # loop through the array sending msg to 'draw' the ASCII
          do (num) ->
            setTimeout (() -> msg.send ent.decode(num)), 30
